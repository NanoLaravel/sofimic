...
<html lang="es">
  ...
  <section>
       ...
       <div class="col-lg-10 pt-2"style="background-color:#eed3ca">
            ...
            <button type="button" class="btn btn-primary mt-3 mb-3" data-toggle="modal" data-target="#ingven" data-whatever="@mdo">nueva venta</button>
            
            <?php } require 'error.msn.php'; ?>
            <p> <a href= "VISTAS/factura.view.php"> generar factura </a> </p>
      ...
      <form class="form-inline my-2" id="search">
          ...
          <div class="col-md-2">
            ...
            <?php 
                ...
                $venvalor_total = $ventas['venvalor_total'];
